    ...
    return (
        ...
        >
            <motion.div
                ...
                className={cn(
                    'mx-auto flex w-fit gap-4 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 px-4',
                    className
                )}
        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className={cn(
                        'absolute -top-6 left-1/2 w-fit whitespace-pre rounded-md border border-white/20 bg-black/80 backdrop-blur-md px-2 py-0.5 text-xs text-white',
                        className
                    )}
                    role='tooltip'
                    style={{ x: '-50%' }}
